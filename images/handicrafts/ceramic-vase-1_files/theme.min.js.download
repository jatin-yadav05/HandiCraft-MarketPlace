...
$(document).ready(function () {
  $("#gift-cart").change(function () {
    if ($(this).is(":checked")) {
      function addfuncgift() {
        $.ajax({
          type: "POST",
          url: "/cart/add.js",
          async: false,
          dataType: "json",
          data: { quantity: 1, id: 39770574618686 },
          success: function (cart) {
            $(".cart__items").append(
              '<div class="cart__item gift" data-key="39770574618686:b756c2a148bee37abb7d47bb2c8259d3" style="/* display:none; */"><div class="cart__image"><a href="/products/gift-wrapping?variant=39770574618686" class="image-wrap"><img src="https://cdn.shopify.com/s/files/1/0030/9759/1872/files/Untitleddesign_1_1_d79bc0c4-10f2-4200-b999-7d471bc01114.jpg?v=1680694800" class="lazyautosizes lazyloaded" data-widths="[180, 360, 540]" data-aspectratio="" data-sizes="auto" alt="Gift Wrapping" data-srcset="https://cdn.shopify.com/s/files/1/0030/9759/1872/files/Untitleddesign_1_1_d79bc0c4-10f2-4200-b999-7d471bc01114.jpg?v=1680694800" sizes="450px" srcset="https://cdn.shopify.com/s/files/1/0030/9759/1872/files/Untitleddesign_1_1_d79bc0c4-10f2-4200-b999-7d471bc01114.jpg?v=1680694800"><noscript><img class="lazyloaded" src="https://cdn.shopify.com/s/files/1/0030/9759/1872/files/Untitleddesign_1_1_d79bc0c4-10f2-4200-b999-7d471bc01114.jpg?v=1680694800" alt="Gift Wrapping"></noscript></a></div><div class="cart__item-details"><div class="cart__item-title"><a href="/products/gift-wrapping?variant=39770574618686" class="cart__item-name">Gift Wrapping</a><div class="cart__item--variants"></div></div><div class="cart__item-sub"><div><div class="cart__remove"><a href="javascript:void(0)" class="remvgftqrp text-link">Remove</a></div></div><div class="cart__item-price-col text-right"><span class="cart__price"><span aria-hidden="true">Rs. 49.00</span><span class="visually-hidden">Rs. 49.00</span></span></div></div></div></div>'
            );
            var getsubtt = $(".cart__item-sub div[data-subtotal]").text();
            var gtsrs = getsubtt.split("Rs. ");
            var gtsrs0ss = gtsrs[1].replace(/[^\d.]/g, "");
            var gtsrs0 = parseFloat(gtsrs0ss) + parseFloat(49.0);
            $(".cart__item-sub div[data-subtotal]").html(
              "Rs. " + gtsrs0.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
            );
            //Rs. 646.25
      ...
      $.ajax({
        ...
        url: "/cart/change.js",
        dataType: "json",
        data: { quantity: 0, id: 39770574618686 },
        success: function (cart) {
          $(".cart__item.gift").remove();
          var getsubtt = $(".cart__item-sub div[data-subtotal]").text();
          var gtsrs = getsubtt.split("Rs. ");
          var gtsrs0ss = gtsrs[1].replace(/[^\d.]/g, "");
          var gtsrs0 = parseFloat(gtsrs0ss) - parseFloat(49.0);
  ...
  $.ajax({
    ...
    success: function (cart) {
      ...
      if (count > 0) {
        $("#gift-cart").attr("checked", "checked");
        $("#gift-cart").prop("checked", "checked");
      }
    },
  });
});
